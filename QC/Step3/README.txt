...
Then, using the result from Outlier.sh, Calculation.R computes the ratios and call rate by dividing each individual's site count by the total site count, retaining the IDs of individuals who pass QC. 
